...
function getSenderEmail(): string {
  ...
  return 'Studio Security <onboarding@resend.dev>';
}
                ...
                <tr>
                  <td align="center">
                    ...
                    <div style="font-size:12px;color:#6b7280;letter-spacing:0.5px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
                      Professional Studio Management Platform
                    </div>
                  </td>
                </tr>
              </table>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  <td style="padding-bottom:20px;">
                    <p style="margin:0;font-size:15px;color:#4b5563;line-height:1.6;">We received a request to reset your password for your Studio account.</p>
                  </td>
                </tr>
                <tr>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:40px;padding-top:24px;border-top:1px solid #e5e7eb;text-align:center;">
                ...
                <tr>
                  <td style="font-size:12px;color:#9ca3af;padding-bottom:4px;">
                    Need help? <a href="mailto:support@studio.com" style="color:#2563eb;text-decoration:none;">support@studio.com</a>
                  </td>
                </tr>
                <tr>
                  <td style="font-size:12px;color:#9ca3af;">
                    &copy; 2026 Studio Workspace. All rights reserved.
                  </td>
                </tr>
              </table>
            </td>
...
export async function sendVerificationEmail(email: string, token: string): Promise<void> {
  ...
  const subject = 'Verify Your Studio Email Address';
  const html = `
<!DOCTYPE html>
<html>
<head>
          ...
          <tr>
            <td style="padding:40px 30px;">
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  <td style="padding-bottom:16px;">
                    <p style="margin:0;font-size:16px;font-weight:600;color:#1f2937;line-height:1.4;">Welcome to Studio</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding-bottom:20px;">
                ...
                <tr>
                  <td style="padding-bottom:24px;">
                    <p style="margin:0;font-size:15px;color:#4b5563;line-height:1.6;">Please verify your email address to activate your account and securely access the Studio platform.</p>
                  </td>
                </tr>
                <!-- Action Button -->
                <tr>
