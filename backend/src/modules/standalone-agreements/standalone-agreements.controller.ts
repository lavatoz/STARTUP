...
export async function createTemplate(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const template = await StandaloneAgreementsService.createTemplate(orgId, { name, version, content });
...
export async function getTemplates(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    const orgId = req.userContext!.organizationId;
    const templates = await StandaloneAgreementsService.getTemplates(orgId);
...
export async function getTemplateById(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    const { id } = req.params;
    const orgId = req.userContext!.organizationId;
    const template = await StandaloneAgreementsService.getTemplateById(orgId, id);
...
export async function updateTemplate(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const updated = await StandaloneAgreementsService.updateTemplate(orgId, id, req.body);
...
export async function deleteTemplate(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const deleted = await StandaloneAgreementsService.deleteTemplate(orgId, id);
...
export async function assignAgreement(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const agreement = await StandaloneAgreementsService.assignAgreement(orgId, clientId, templateId, linkedQuoteId);
...
export async function getClientAgreement(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const agreements = await StandaloneAgreementsService.getClientAgreement(orgId, clientId);
...
export async function getDocuments(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const docs = await StandaloneAgreementsService.getDocuments(orgId, agreementId);
...
export async function deleteDocument(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const doc = await prisma.standaloneAgreementDocument.findFirst({
      where: {
        id: documentId,
        agreement: { organizationId: orgId },
      },
    ...
    await StandaloneAgreementsService.deleteDocument(orgId, documentId);
...
export async function downloadDocument(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const doc = await StandaloneAgreementsService.getDocumentForDownload(orgId, documentId, user);
...
export async function getSignature(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const signature = await StandaloneAgreementsService.getSignature(orgId, agreementId, user);
    if (!signature) {
...
export async function generatePdf(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const filePath = await StandaloneAgreementsService.generateSignedAgreementPdf(orgId, agreementId);
...
export async function linkQuotation(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const updated = await StandaloneAgreementsService.linkQuotation(orgId, agreementId, linkedQuoteId);
...
export async function acceptQuotationController(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const agreement = await StandaloneAgreementsService.acceptQuotation(orgId, quotationId);
...
export async function getClientAgreementsListController(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const list = await StandaloneAgreementsService.getClientAgreementsList(orgId, user, clientIdParam);
...
export async function getClientAgreementDetailsController(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const details = await StandaloneAgreementsService.getClientAgreementDetails(orgId, id, user);
