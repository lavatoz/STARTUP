...
export class MessagesService {
   ...
   */
  static async checkProjectAccess(orgId: string, projectId: string, user: any) {
  ...
  static async getMessages(
    ...
    // 1. Verify access
    await this.checkProjectAccess(orgId, projectId, user);
   ...
   */
  static async createMessage(orgId: string, projectId: string, user: any, messageText: string) {
    // 1. Verify access and get project data
    const project = await this.checkProjectAccess(orgId, projectId, user);
