 ...
 */
async function checkProjectAccess(user: any, projectId: string, orgId: string): Promise<any> {
...
export async function getProjectGalleryPhotos(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const project = await checkProjectAccess(user, projectId, req.userContext!.organizationId);
...
export async function updateGalleryStatus(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    await checkProjectAccess(user, projectId, req.userContext!.organizationId);
