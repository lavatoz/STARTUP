 ...
 */
async function validateProjectAccess(user: any, projectId: string, orgId: string): Promise<any> {
...
export async function togglePhotoSelection(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const project = await validateProjectAccess(user, projectId, req.userContext!.organizationId);
...
export async function submitPhotoSelection(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    await validateProjectAccess(user, projectId, req.userContext!.organizationId);
    const gallery = await getOrCreateProjectGallery(projectId);
