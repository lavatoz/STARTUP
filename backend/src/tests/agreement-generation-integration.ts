...
export async function runTests() {
  ...
  const testManagerUser = { id: 'mgr-1', email: 'manager@apco.com', role: Role.Manager, organizationId: 'org-id' };
  const testClientUser = { id: 'client-1', email: 'client@apco.com', role: Role.Client, organizationId: 'org-id' };
