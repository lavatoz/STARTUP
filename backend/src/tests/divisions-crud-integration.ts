...
function mockRequestResponse(body = {}, params = {}, query = {}, file?: any, user?: any) {
  const req = {
    ...
    userContext: user ? {
      userId: user.id,
      organizationId: user.organizationId || 'de305d54-75b4-431b-adb2-eb6b9e546014',
...
export async function runTests() {
  ...
  // Define mock users
  const adminUser = { id: 'admin-1', email: 'admin@apco.com', role: Role.SystemAdmin, organizationId: 'de305d54-75b4-431b-adb2-eb6b9e546014' };
  const clientUser = { id: 'client-1', email: 'client@apco.com', role: Role.Client, organizationId: 'de305d54-75b4-431b-adb2-eb6b9e546014' };
