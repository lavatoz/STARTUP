    ...
    <div className="min-h-screen bg-transparent flex items-center justify-center px-4 selection:bg-white selection:text-black relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-ios-slide-up relative z-10">
        <div className="text-center mb-6 md:mb-10">
          ...
          <h1 className="text-xl md:text-3xl font-black uppercase tracking-[0.2em] text-white">Studio</h1>
          ...
          {view === 'LOGIN' && (
            <>
              ...
              <div className="flex flex-col gap-3 mt-6 text-center">
                <Link to="/forgot-password" className="text-zinc-500 hover:text-white text-[10px] font-black uppercase tracking-widest transition-colors">
                  Forgot Password?
                </Link>
                <div className="border-t border-white/5 pt-4">
                  <Link to="/register" className="text-white hover:text-zinc-300 text-[10px] font-black uppercase tracking-widest transition-colors">
