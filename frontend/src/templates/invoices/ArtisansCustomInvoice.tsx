  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="flex justify-between items-start mb-8 relative z-10">
          ...
          <div className="flex items-center gap-3">
            {company?.logo ? (
              ...
              <div className="w-12 h-12 bg-white/5 border border-white/10 flex items-center justify-center rounded-lg text-sm font-bold text-white uppercase">
                 {(company?.companyName || 'S').charAt(0)}
              </div>
            )}
            <div>
              <span className="text-[10px] tracking-[0.25em] text-zinc-500 font-bold uppercase block">{company?.companyName || 'Studio'}</span>
              {company?.tagline && <span className="text-[8px] tracking-widest text-zinc-600 block uppercase">{company.tagline}</span>}
            </div>
          </div>
        ...
        {/* Center Main Company Logo or Typography */}
        <div className="flex flex-col items-center justify-center mb-12 relative z-10">
          {company?.logo ? (
            ...
            <div className="text-center">
              <h2 className="text-3xl font-serif font-black tracking-widest text-white uppercase">
