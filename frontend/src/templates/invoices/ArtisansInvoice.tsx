    ...
    <div className="bg-[#09090b] text-zinc-300 p-12 min-h-[800px] w-full max-w-4xl mx-auto font-sans relative border border-white/10">
      ...
      <div className="flex justify-between items-start mb-16 border-b border-white/10 pb-8">
        <div className="flex items-center gap-4">
           ...
           <div>
              <h1 className="text-2xl font-black text-white uppercase tracking-widest">{company?.companyName || 'Studio'}</h1>
              <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mt-1">{company?.tagline || 'Creative Production'}</p>
           </div>
        </div>
